...
After you have installed the plug-in, none of the contacts has the
transliteration switched on. To activate the transliteration for a contact who
can not read Cyrillic chars, open the contact menu (right mouse button on the
contact entry in the contact list, or the contact menu button in the message
dialog), and check on the "Transliterate" menu item. From now on, all the sent
text messages will be transliterated for the contact, until you uncheck the menu
item in the contact menu.
